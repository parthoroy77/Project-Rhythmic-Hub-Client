        ...
        <div className='my-28 px-6 lg:px-24'>
            <div className='space-y-10'>
                <div className='flex flex-col lg:flex-row items-center gap-3 justify-evenly'>
                    <h1 data-aos='fade-right' className='lg:text-5xl font-bold text-xl font-serif'>Our class, is where your passions <br /> come into play every day.</h1>
                ...
                <div className='grid grid-cols-1 gap-y-10 gap-x-5  lg:grid-cols-4'>
                    <div data-aos='fade-up' className='hover:bg-amber-300 border-2 px-5 rounded-lg py-5'>
                    ...
                    <div data-aos='fade-up' className='hover:bg-sky-300 border-2 px-5 rounded-lg py-5'>
                        <div className='space-y-3'>
                            <div className='flex text-2xl font-mono gap-3'>
